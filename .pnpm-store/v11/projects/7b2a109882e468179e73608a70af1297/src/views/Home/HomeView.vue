...
.home-view {
  ...
  max-width: 640px;
  margin: 0 auto;
  background: linear-gradient(rgba(248, 252, 245, 0.72), rgba(248, 252, 245, 0.72)), url('/assets/backgrounds/bg_home.png') center / cover;
...
@media (max-width: 768px) {
  ...
  .team-pets { flex-direction: column; gap: 6px; }
}
</style>

  ...
  <div class="pokedex-page">
    ...
    <div class="pokedex-grid">
      ...
      >
        ...
        <div class="card-icon">
          ...
          <img v-else :src="`/assets/pets/icons/pet_${entry.speciesId}_icon_64.png`" :alt="entry.name ?? '宠物'" />
        </div>
        <div class="card-name">
    ...
    <div v-if="showDetail && selectedSpecies" class="detail-overlay" @click.self="closeDetail">
      <div class="detail-panel">
        ...
        <img
          v-if="selectedSpecies.researchLevel >= 1"
          class="detail-portrait"
          :src="`/assets/pets/portraits/pet_${selectedSpecies.speciesId}_portrait.png`"
          :alt="selectedSpecies.name ?? '宠物立绘'"
        />

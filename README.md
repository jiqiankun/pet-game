...
> 正式游戏美术资源已接入。桌面重构阶段 0 已冻结现有交互路径与视觉采集口径；运行态基线证据与补采条件见 [阶段 0 桌面视觉基线说明](docs/development/baseline-assets/README.md)。
...
│   ├── build.sh / build.bat / start.sh / start.bat / dev-hint.bat / phase0-baseline.ps1
│   └── e2e/           #   E2E 验收脚本
...
- [《宠物精灵桌面版世界与 UI 重构完整需求文档 V1.0》](docs/requirements/宠物精灵_桌面版世界与UI重构_完整需求文档_V1.0.md) — 当前桌面重构需求与 R-001～R-205 的最高项目内依据
...
- [《桌面版世界/UI 重构详细任务规划》](docs/planning/宠物精灵_需求变更与桌面版世界UI重构_详细任务规划.md) — 当前阶段顺序、范围与验收标准
- [阶段 0 基线与需求裁决](docs/development/PHASE0_BASELINE.md) — 裁决、基线、追踪矩阵和迁移样本

...
function getElementColor(elementId: string): string {
  const map: Record<string, string> = {
    METAL: '#C0C0C0', WOOD: '#7ED321', WATER: '#4A90D9', FIRE: '#D0021B',
    EARTH: '#8B6914', WIND: '#90CAF9', THUNDER: '#F5A623', LIGHT: '#FFD700', DARK: '#6A1B9A',
  }
  return map[elementId] || '#888'
}
</script>
        ...
        <div class="pet-options">
          ...
          >
            <div class="pet-header">
              <span class="pet-element" :style="{ backgroundColor: getElementColor(pet.element) }">

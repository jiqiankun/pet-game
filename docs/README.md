...
| `deployment/` | 部署指南（唯一主要部署文档） | 部署流程 / 环境变化时 |
| `guide/` | 快速开始与玩家玩法指南 | 流程 / 玩法变更时 |
...
- [部署指南](deployment/DEPLOYMENT.md) — 唯一主要部署文档：环境准备、数据库初始化、构建发布、故障排查、部署前检查清单
- [快速开始（最简启动）](guide/QUICK_START.md)
